<div class="w-full mt-10 p-2">
    <div class="p-2 max-w-7xl mx-auto bg-slate-200 shadow-md rounded-xl border-all">
        ...
        <form wire:submit.prevent="submitDate">
            ...
            <div 
                x-data="{ showActions: false, openSignatoryMenu: false }" 
                class="flex justify-center items-center gap-2 p-2"
            >
                <x-button 
                    submit 
                    round 
                ...
                <template x-if="showActions">
                    <div class="flex items-center gap-2">
                        <x-button 
                            ...
                            icon="pencil" 
                            color="slate" 
                            x-on:click="$modalOpen('modal-rectify')"
                        >
                            Rectify
                        </x-button>
                        <div class="relative inline-block">
                            ...
                            <div 
                                x-show="openSignatoryMenu"
                                @click.away="openSignatoryMenu = false"
                                x-transition
