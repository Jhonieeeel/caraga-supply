            ...
            foreach (($block['accommodations'] ?? []) as $accIndex => $acc) {
                ...
                foreach (($acc['items'] ?? []) as $accItemIndex => $accItem) {
                    PrAccommodationItem::create([
                        ...
                        'no_days' => $accItem['no_days'] ?? 0,
                        'room_type' => $accItem['room_type'] ?? null,
                        'room_arrangement' => $accItem['room_arrangement'] ?? null,
                        'inclusive_dates' => $accItem['inclusive_dates'] ?? null,
                        'remarks' => $accItem['remarks'] ?? null,
